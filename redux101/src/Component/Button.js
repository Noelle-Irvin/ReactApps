...
//it will need a function to do so. Once the function runs,
//	the dispatcher will let ALL reducers know.
...
//mapDispatchToProps takes whatever functions that need to be sent out to the dispatcher
...
// or this way: export default connect(null, mapDispatchToProps)(Button);
